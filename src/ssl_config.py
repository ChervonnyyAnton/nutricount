...
from datetime import datetime, timedelta, timezone
            ...
            with open(self.cert_file, "wb") as f:
                ...
                logger.info("Self-signed certificate generated for {hostname}")
            return True
            ...
            return False
                ...
                logger.error("SSL certificate generation error: {e}")
            return False
...
from cryptography.hazmat.primitives import serialization
            ...
            logger.error("Certificate info error: {e}")
            return None
...
from datetime import datetime, timezone
    ...
    def get_ssl_context(self):
        ...
        try:
            ...
            logger.error("SSL context creation error: {e}")
            return None
...
def setup_security_middleware(app):
    ...
    @app.before_request
    def log_request():
            logger.info("Request: {request.method} {request.path} from {request.remote_addr}")
