...
### ⚠️ Что есть в CalApp, но нет в Nutricount
...
| **Голосовой ввод** | 🔴 ВЫСОКИЙ | 🟡 СРЕДНЯЯ | 4-6 дней |
| **Сканер штрих-кодов** | 🔴 ВЫСОКИЙ | 🟡 СРЕДНЯЯ | 5-7 дней |
| **Система достижений** | 🟡 СРЕДНИЙ | 🟡 СРЕДНЯЯ | 5-7 дней |
| **AI распознавание фото** | 🔴 ВЫСОКИЙ | 🔴 ВЫСОКАЯ | 10-15 дней |
| **AI рекомендации** | 🟢 НИЗКИЙ | 🔴 ВЫСОКАЯ | 15-20 дней |
| **Синхронизация Health** | 🟢 НИЗКИЙ | 🔴 ВЫСОКАЯ | 10-15 дней |
...
### Приоритет 2: После Фазы 1 📊

5. **Голосовой Ввод** (4-6 дней)
   - Современная функция
   - Web Speech API (встроен в браузеры)
   - Удобство hands-free

6. **Сканер Штрих-кодов** (5-7 дней)
   - Быстрое добавление продуктов
   - Open Food Facts API (бесплатно)
   - Часто запрашиваемая функция

---

### Приоритет 3: Продвинутые Функции 🤖

7. **Распознавание Фото** (10-15 дней)
   - Революционный UX
   - Требует решения по подходу (Cloud vs Local)
   - Высокие затраты разработки

8. **AI Рекомендации** (15-20 дней)
   - Умные предложения
   - Сначала простые правила
   - Позже ML если нужно
...
**Ключевое Открытие:**
Nutricount уже имеет **уникальные функции**, которых нет в CalApp (голодание, GKI, кето-рейтинг, самохостинг). Добавив удобные функции CalApp (цели, избранное, голосовой ввод), получим **лучшее приложение в обоих мирах**! 🏆
