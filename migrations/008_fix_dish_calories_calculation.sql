-- Fix dish calories calculation in log_entries_with_details view
-- The issue was that dish calories were calculated incorrectly using /100.0 instead of /total_weight_grams
